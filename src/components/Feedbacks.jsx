...
<div className="flex-1 fllex-col ">

<p className="text-white font-medium text-[16px] "> <span className="blue-text-gradient">@</span>
{name}
</p>
...
<img src={image} alt={`feedback by ${name}`} className="w-10 rounded-full object-cover h-10"/>
